...
## Import Data
```{r}
infantmort<-read_excel("C:\Users\Daisz\Box\Advanced Data Analysis (F23)\Project\Project_Repository\Infant Mortality Income Inequality & Segregation Dataset.xlsx")
```
